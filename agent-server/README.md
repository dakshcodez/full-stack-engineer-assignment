...
Mock AI agent backend for the Full Stack AI Engineer internship assignment.

This server simulates a context-aware AI agent that streams responses over WebSocket, makes tool calls mid-stream, sends context snapshots, and — in chaos mode — introduces real-world failure conditions.
